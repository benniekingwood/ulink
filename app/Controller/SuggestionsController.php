...
//ef
    ...
    function admin_suggestion_index() {
        ...
        if (isset($this->request->data['Suggestion']['searchText'])) {
            $this->Session->write('advancedSuggestionSearch', $this->request->data['Suggestion']['searchText']);
            $searchText = $this->request->data['Suggestion']['searchText'];
        } elseif ($this->Session->check('advancedSuggestionSearch')) {

            if (isset($this->request->params['named']['page'])) {
                $searchText = $this->request->data['AdvancedSearch'] = $this->Session->read('advancedSuggestionSearch');
            } else {
