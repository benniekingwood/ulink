            ...
            <div style="width:700px; margin:auto">
                <div class="userProfileimage">
                    ...
                    <?php if ($User['User']['image_url'] != '' && file_exists(WWW_ROOT . '/img/files/users/' . $User['User']['image_url'])) {
                        ...
                        <?php echo $this->Html->image(('files/users/' . $User['User']['image_url'] . '', array('alt' => '', 'height' => '150', 'width' => '150')); ?>


                    <?php } else { ?>

                        <img alt="" border="0" src="<?php echo($this->Html->url('/thumbs/index/')); ?>?src=/app/webroot/img/files/users/noImage.jpg&w=150&h=150" />
                    <?php } ?>
                ...
                <div class="userDetails"><strong>School:</strong><a href="<?php echo($this->Html->url('/schools/detail/' . $User['School']['id'] . '')); ?>"><?php echo $User['School']['name']; ?></a></div>
