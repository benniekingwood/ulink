...
<div>
     ...
     <table border="0" cellpadding="0" cellspacing="0" width="100%">
		 ...
		 <td><a href="<?php echo($this->Html->url('/admin/users/user_edit/'.$user['User']['id'])); ?>">Edit</a></td>
		 <td><a href="<?php echo($this->Html->url('/admin/users/user_delete/'.$user['User']['id'])); ?>">Remove</a></td>                 
              </tr>
		<?php } ?>
     </table>
    ...
    <script type="text/javascript">
          $(document).ready(function() {
            loadPiececho("<?php echo $this->Html->url(array('controller'=>'Users','action'=>'admin_index'));?>","#imageList");
             });
    </script>
   <div id="imageList">
