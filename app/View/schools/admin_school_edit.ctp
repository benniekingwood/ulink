...
<script type="text/javascript" languagej="javascript">
    ...
    $(document).ready(function(){
        ...
        //On Change
        //SchoolYear.changecho(validateYearSel);
	
        //On Submitting
        form.submit(function(){
	  
            if(validateZipCodecho() & validateYear() & validateNamecho() & validateShortDescription()  & validateAddress() & validateAttendencecho() & validateLatitudecho() & validateLongitudecho() & validateschoolDomain())
                return true;
            else
                return false;
        });
        function validateZipCodecho(){
            //if it's NOT valid
        ...
        function validateAttendencecho(){
            //if it's NOT valid
...
<div class="login">
    ...
    <?php if ($this->data['School']['image_url']) { ?>
        <div id="imageshow"><?php echo $this->Html->image(('files/schools/' . $this->data['School']['image_url'] . '', array('alt' => '', 'height' => '100', 'width' => '100')); ?>
            <br/><?php echo $this->Html->link('Remove Image', array('action' => 'school_delimage', $this->data['School']['id'], $this->data['School']['image_url']), array('class' => 'confirm_delete', 'id' => $this->data['School']['id'], 'image_url' => $this->data['School']['image_url'])); ?></div>
        ...
        <div class="login_form">
            ...
            <table>
                ...
                for ($j = 0; $j < count($this->data['Image']); $j++) {
                    ...
                    ?>
                    <td><div id="<?php echo $this->data['Image'][$j]['id']; ?>"><?php echo $this->Html->image(('files/test/' . $this->data['Image'][$j]['url'] . '', array('alt' => '', 'height' => '100', 'width' => '100')); ?>
                            <br/><?php echo $this->Html->link('Remove Image', array('action' => 'school_extdelimage', $this->data['Image'][$j]['id'], $this->data['Image'][$j]['url']), array('class' => 'confirm_delete_extra', 'id' => $this->data['Image'][$j]['id'], 'image_url' => $this->data['Image'][$j]['url'])); ?></div></td>
                    <?php
