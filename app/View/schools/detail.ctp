        ...
        <div class="rating">
            <span class="right"><?php
					...
					if(empty($School['School']['rating'])){
						...
						echo $this->Html->image(('star-'.$School['School']['rating'].'.gif',array('title'=>$School['School']['rating'].' star'));?><?php }?></span>
        ...
        <div class="info">
            <div class="inner">
                <div class="innerContent"><?php echo $School['School']['description']; ?>
                    ...
                    <div class="links">
                        <a href="<?php echo($this->Html->url('/reviews/allvideoreview/'.$School['School']['id'].'')); ?>">Video Reviews </a>
								 |  <a href="<?php echo($this->Html->url('/reviews/alltextreview/'.$School['School']['id'].'')); ?>">Written Reviews</a>
								  |<a href="<?php echo($this->Html->url('/maps/map_index/'.$School['School']['id'])); ?>">&nbsp;View Map</a>
                    </div>
                    <div class="clear"></div>
                    <br />
                ...
                <ul>
                    ...
                    <li style="float:none;">
                        <div class="selectedPic">
                            <img alt="" border="0" src="<?php echo($this->Html->url('/thumbs/index/')); ?>?src=/app/webroot/img/files/test/<?php echo $School['Image'][$j]['url'];?>&w=283&h=283" />
                        </div>
                    </li>
						<?php }  ?>
                </ul>
        ...
        <div class="recent">
            ...
            <div class="content">
                ...
                <div class="videoListing">
                                                                        <?php 
                                                                            if ($School['School']['image_url'] == "" || !is_filecho($this->Html->url('/app/webroot/img/files/users/'.$School['School']['image_url'])) ) {
                                                                                $School['School']['image_url'] = "noImage.jpg";
                                                                            }
                                                                        ?>  
                    <img alt="" border="0" src="<?php echo($this->Html->url('/thumbs/index/')); ?>?src=/app/webroot/img/files/schools/<?php echo $School['School']['image_url'];?>&w=68&h=50" />
                    <span>
        ...
        <div class="recent">
            ...
            <div class="content">
                ...
                <div class="videoListing">
                    ...
                    <a href="<?php echo($this->Html->url('/reviews/videoreview/'.$RecentVideoReview[$m]['Review']['id'].'')); ?>"><?php echo $VideoReviewCaps[$m]['image_thumb'][0]; ?></a>
                    <span>
                        <a href="<?php echo($this->Html->url('/reviews/videoreview/'.$RecentVideoReview[$m]['Review']['id'].'')); ?>"><?php echo substr($RecentVideoReview[$m]['Review']['title'],0,15); ?><?php if(strlen($RecentVideoReview[$m]['Review']['title'])>15 ) echo "..."; ?></a><br />
									...
									echo $this->Html->image(('review_star_'.$RecentVideoReview[$m]['Review']['rating'].'.png',array('title'=>$RecentVideoReview[$m]['Review']['rating'].' star')); }?>
                    </span>
                    <div class="clear"></div>
                </div>
            ...
            <div class="bottom">
                ...
                <div class="clear"></div>
					...
					<?php if(count($VideoReviewCaps) != 0) {?>	<a href="<?php echo($this->Html->url('/reviews/allvideoreview/'.$School['School']['id'].'')); ?>" class="viewAll">View All Listings</a>
					<?php } ?>
        </div>
        ...
        <div class="recent">
                ...
                <ul class="writtenReviews">
                    ...
                    <li class="<?php echo $class; ?>">
                        ...
                        <span class="right"><?php $i++;
							...
							echo $this->Html->image(('review_star_'.$otherWrittenReview['Review']['rating'].'.png',array('title'=>$otherWrittenReview['Review']['rating'].' star')); }?></span>
                        <span class="content">
								<?php echo substr($otherWrittenReview['Review']['description'],0,40); ?>...
                        </span>
                        <span class="right"><a href="<?php echo($this->Html->url('/reviews/textreview/'.$otherWrittenReview['Review']['id'].'')); ?>"  class="home_read"><div class="read_more">Read More</div></a></span>
                    </li>                                                                                                                  
								<?php } ?>
                    <li class="clear"></li>
                </ul>
            ...
            <div class="bottom">
                ...
                <div class="clear"></div>
						...
						<?php if(count($OtherWrittenReview) != 0) { ?> <a href="<?php echo($this->Html->url('/reviews/alltextreview/'.$School['School']['id'].'')); ?>" class="viewAll">View All Reviews</a> <?php } ?>
        </div>
