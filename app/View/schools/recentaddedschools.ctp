            ...
            <div class="sliderContent">
                <span class="sliderImage">
                    <a href="schools/detail/<?php echo $school['School']['id']; ?>">
                        <img alt="" border="0" src="<?php echo($this->Html->url('/thumbs/index/')); ?>?src=/app/webroot/img/files/schools/<?php echo $school['School']['image_url']; ?>&w=50&h=50" /></a></span>
                <span>
                    ...
                    if ($school['School']['rating'] > 0) {
                        echo $this->Html->image(('star-' . $school['School']['rating'] . '.gif', array('title' => $school['School']['rating'] . ' star'));
                    }
                    ?>
                </span>
