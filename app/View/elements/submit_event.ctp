    ...
    <div class="modal-body">
        ...
        <div id="submit-event-form-container" class="control-group">
            ...
            <div class="controls">
                ...
                <?php echo $this->Form->input('Event.eventDate', array('id' => 'eventDate', 'type' => 'text', 'data-date-format'=>'mm/dd/yy', 'class' => 'input-large ulink-input-bigfont','maxlength' => '10', 'label'=>false, 'div'=>false, 'placeHolder' => 'MM/DD/YYYY')); ?>
