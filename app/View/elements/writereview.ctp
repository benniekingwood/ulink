<script type="text/javascript" language="javascript">
    ...
    function setDescriptioncookiecho()
    {
        ...
        document.cookie = 'reviewDescription'+"="+escapecho(description)+"; path=/";			
        return true;
    }
...
//echo $_SERVER['SERVER_NAME'];
                    ...
                    <div id="reviewResponse">	
                        ...
                        <div class="main-field-contianer">
                            ...
                            <?php echo $this->Form->input('Review.descriptionarea', array('id' => 'textarea2', 'label' => false, 'type' => 'textarea', 'value' => $usertextreview[0]['Review']['description'], 'class' => 'mceAdvanced')); ?>
            ...
            <?php }
        } else { ?><div class="login">Please <a href="<?php echo $this->Html->url('/users/login'); ?>" class="login">Log In</a> to submit a review
