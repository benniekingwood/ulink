    ...
    <div id="leftContent">
        <div class="user-rating">
            <div class="userName">
                ...
                <?php
                if ($Review['User']['image_url'] == "" || !is_filecho($this->Html->url('/app/webroot/img/files/users/' . $Review['User']['image_url']))) {
                    $Review['User']['image_url'] = "noImage.jpg";
                }
                ?> 

                <img alt="" border="0" src="<?php echo($this->Html->url('/thumbs/index/')); ?>?src=/app/webroot/img/files/users/<?php echo $Review['User']['image_url']; ?>&w=50&h=50" />



                <a href="<?php echo($this->Html->url('/users/userinfo/' . $Review['User']['id'] . '')); ?>"><?php echo ucwords($Review['User']['firstname']); ?></a></div>

            <div class="rating">
                <span class="right"><?php echo $this->Html->image(('star-' . $Review['Review']['rating'] . '.gif', array('title' => $Review['Review']['rating'] . ' star')); ?></span>
        ...
        <div class="boxBottom">
            ...
            <div class="date"><?php echo datecho("d M, Y ", strtotimecho($Review['Review']['created'])); ?></div>
            <div class="links">

                <a href="<?php echo($this->Html->url('/reviews/allvideoreview/' . $Review['School']['id'] . '')); ?>">

					Video Reviews</a>  |  <a href="<?php echo($this->Html->url('/schools/detail/' . $Review['School']['id'] . '')); ?>">School Information</a>
            </div>
            <div class="clear"></div>
        </div>
        <br />
                    ...
                    <ul class="writtenReviews">
                        ...
                        foreach ($Othereview as $othereview) {
                            ...
                            <li class="<?php echo $class; ?>" >
                                ...
                                <span class="right"><?php echo $this->Html->image(('review_star_' . $othereview['Review']['rating'] . '.png', array('title' => $othereview['Review']['rating'] . ' star')); ?></span>
                                <span class="content">
...
<?php } ?>
            ...
            <a href="<?php echo($this->Html->url('/reviews/alltextreview/' . $Review['School']['id'] . '')); ?>" class="viewAll">View All Reviews </a>
            <div class="clear"></div>
        </div>
        <br />
    ...
    <?php for ($m = 0; $m < count($VideoReviewCaps); $m++) { ?>
                        <div class="videoListing">
                            ...
                            <a href="<?php echo($this->Html->url('/reviews/videoreview/' . $OtheerVideoReview[$m]['Review']['id'] . '')); ?>"><?php echo $VideoReviewCaps[$m]['image_thumb'][0]; ?></a>
                            <span>
                                <a href="<?php echo($this->Html->url('/reviews/videoreview/' . $OtheerVideoReview[$m]['Review']['id'] . '')); ?>"><?php echo substr($OtheerVideoReview[$m]['Review']['title'], 0, 15); ?><?php if (strlen($OtheerVideoReview[$m]['Review']['title']) > 15)
                            echo "..."; ?></a><br />
        <?php echo number_format($VideoReviewCaps[$m]['count'][0]); ?> views<br />
        <?php echo $this->Html->image(('review_star_' . $OtheerVideoReview[$m]['Review']['rating'] . '.png', array('title' => $OtheerVideoReview[$m]['Review']['rating'] . ' star')); ?>
                            </span>
                            <div class="clear"></div>
                        </div>
...
<?php } ?>
            ...
            <a href="<?php echo($this->Html->url('/reviews/allvideoreview/' . $Review['School']['id'] . '')); ?>" class="viewAll">View All Reviews </a>
            <div class="clear"></div>
        </div>
