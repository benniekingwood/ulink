<div class="content">
    ...
    if ($total) {
                ...
                <div class="info">
                    <div class="inner">
                        <div class="innerContent">
                            ...
                            <?php echo $this->Html->image(('files/schools/' . $serchResultsReviews[$i]['School']['image_url'] . '', array('alt' => '', 'height' => '112', 'width' => '112')); ?>
        ...
        <?php } ?>
                            <div class="searchresult"><strong>Rating :</strong><?php echo $this->Html->image(('star-' . $serchResultsReviews[$i]['Review']['rating'] . '.gif', array('alt' => '')); ?></div>
                            <div class="searchresult"><strong>School :</strong><a href="<?php echo($this->Html->url('/schools/detail/' . $serchResultsReviews[$i]['School']['id'] . '')); ?>"><?php echo $serchResultsReviews[$i]['School']['name']; ?></a></div>
                            <div class="searchresult">
                                <span class="top_padd"><a href="<?php echo($this->Html->url('/reviews/' . $serchResultsReviews[$i]['Review']['type'] . 'review/' . $serchResultsReviews[$i]['Review']['id'])); ?>"><?php echo $this->Html->image(('buttonViewdetails.gif') ?></a></div>
                            </span>
                            <div class="clear"></div>
                        </div>
                    </div>
