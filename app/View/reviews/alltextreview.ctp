  ...
  <?php 
	...
	<div class="textReviewdetails "><strong>Total Reviews:</strong><?php echo $Firstreview ?></div>
	    ...
	    <?php if(!isset($MyReview)){ ?>
			...
			<?php echo $this->Html->image(('write-a-review.gif',array('alt'=>'')); ?></a></div>
			<?php } ?>
	...
	<?php } else { ?>
		...
		<?php } else { ?>
			...
			<?php echo $this->Html->image(('modify.gif',array('alt'=>'')); ?></a>
			</div>
	...
	<div id="slider">
		...
		<div class="info">
			<div class="inner">
				...
				<span class="reviewDate"><a href="<?php echo($this->Html->url('/reviews/textreview/'.$alltextreview['Review']['id'].'')); ?>" class="home_read"><div class="read_more left">Read More</div></a> &nbsp; |  Posted on <?php echo datecho("d M, Y ", strtotimecho($alltextreview['Review']['created'])); ?> by <?php echo ucwords($alltextreview['User']['firstname']); ?></span>
				</div>
				<div class="clear"></div>
			</div>
		</div>
