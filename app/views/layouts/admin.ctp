...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php
        echo $html->meta('icon');
        echo $html->css(array('style_admin.css'));
    ...
    <body>
        ...
        <div id="mainContainer">
            <div id="header">
                <div class="left"><?php echo $html->image('logouLinkv2.png', array('alt' => '')); ?></div>
                <div class="topLinks">
                ...
                <div class="searchPanel">
                    <div class="left">
                        <a href="index.html"><?php echo $html->image('home-icon.gif', array('alt' => '')); ?></a>
                        <a href="map.html"><?php echo $html->image('map-icon.gif', array('alt' => '')); ?></a>
                    </div>
                    <div class="right"></div>
                    <div class="search">
