...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml" >
    <head>
        ...
        <?php
        echo $html->meta('icon');
        echo $html->css(array('style.css', 'autofill.css', 'pop_thickbox.css', 'thickbox.css'));
...
if ($schools != null) {
    foreach ($schools as $school) {
        $distance = AppController::get_distance($school['School']['latitude'], $UserLatitiude, $school['School']['longitude'], $UserLongitude);
            ...
            { 
                ...
                { 
                    case '0': str="<div class='inner'>Review approval pending</div>"; 
                        break;
                    case '1': str="<a class='thickbox right' href= '<?php echo $html->url('/reviews/alltextreview/'); ?>"+id+"'><img alt='' src='"+hostname+"app/img/modify.gif'></a>";
                        break;
                    case '2': str="<a class='thickbox right' href= '<?php echo $html->url('/reviews/alltextreview/'); ?>"+id+"'><img alt='' src='"+hostname+"app/img/write-a-review.gif'></a>";
                        break;
                    }
                ...
                if(ratingCount!=0)
                {
                    var ratingValue="<div class='inner last'><strong>Rating:</strong><a href='<?php echo $html->url('/reviews/alltextreview/'); ?>"+id+"'><img src='"+hostname+"app/img/star-"+ratingCount+".gif' title='"+ratingCount+"' /></a></div>";
                ...
                var html = "<div class='mapContent' ><a href='<?php echo $html->url('/schools/detail/'); ?>"+id+"'><img src='"+hostname+"app/img/files/schools/"+image_url+"' width='90' height='90'/></a><div class='content'><h1><a href='<?php echo $html->url('/schools/detail/'); ?>"+id+"'>"+name+"</a></h1>" +
        ...
        <div id="mainContainer">
            <div class="main_inner_container">
                <div id="leftSliderWrap">
					...
					<a href="<?php e($html->url('/')); ?>"><?php echo $html->image('submit_review_icon.gif', array('alt' => 'submit a review')); ?></a>
					<a href="<?php e($html->url('/')); ?>"><?php echo $html->image('rated-icon.gif', array('alt' => 'suggest a school')); ?></a> -->
                ...
                <div id="header">
                    <div class="left"><?php echo $html->link($html->image("logouLinkv2.png"), array('controller' => 'pages', 'action' => 'home'), array('escape' => false)); ?></div>
