...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml" >
    <head>
        ...
        echo $html->meta('icon');
        echo $html->css(array('style.css', 'jquery_006.css', 'pop_thickbox.css', 'thickbox.css', 'autofill.css'));
        echo $javascript->link(array('var.js', 'jquery.js', 'easySlider.packed.js', 'jquery_004.js', 'thickbox.js', 'jquery_013.js', 'global_fn.js', 'form-submit.js', 'ajax.js', 'autofill.js', 'validate.js', 'jquery.form.js','tiny_mce/tiny_mce.js'));
        echo $javascript->link(array( 'check_user_script.js', 'autofill.js', 'tiny_mce/tiny_mce.js', 'jquery.tools.min.js'));
        ...
        <script type="text/javascript">
            ...
            function ajaxDo(contrl,action) {
                $.ajax({
                    ...
                    beforeSend:  function() { 
                        $('#switchContent').html('<div class=\'imageLoagGif\'><center><?php echo $html->image('ajax-loader.gif', array('alt' => 'Loading...')); ?></center></div>');
                    },
        ...
        <div id="mainContainer">
            <div class="main_inner_container">
                    ...
                    <div class="searchPanel">
                        <div class="left">
                            <a href="<?php e($html->url('/')); ?>">
                                <?php echo $html->image('home-icon.gif', array('alt' => 'home', 'title' => 'uLink home')); ?>
                            </a>

                            <a href="<?php e($html->url('/maps/map_index')); ?>">
                                <?php echo $html->image('map-icon.gif', array('alt' => 'map of schools', 'title' => 'map of schools')); ?>
                            </a>

                        </div>
                        <div class="right">
                            <?php echo $html->image('search-bar-right.gif', array('alt' => '')); ?>
                        </div>
                        ...
                        <div class="jcarousel-clip jcarousel-clip-horizontal">
                            <ul id="features" class="jcarousel-list jcarousel-list-horizontal">
                                <li jcarouselindex="1" class="jcarousel-item jcarousel-item-horizontal jcarousel-item-1 jcarousel-item-1-horizontal">
                                    <?php echo $html->image('slider.jpg', array('alt' => '')); ?>
                                </li>
                                <li jcarouselindex="1" class="jcarousel-item jcarousel-item-horizontal jcarousel-item-1 jcarousel-item-1-horizontal">
                                    <a href="#"><?php echo $html->image('slider.jpg', array('alt' => '')); ?></a>
                                </li>
                                <li jcarouselindex="1" class="jcarousel-item jcarousel-item-horizontal jcarousel-item-1 jcarousel-item-1-horizontal">
                                    <?php echo $html->image('slider.jpg', array('alt' => '')); ?>
                                </li>
                ...
                <div id="whiteContentBox" class="clear">
                    <div class="top">
                        <span class="left">
                            <?php echo $html->image('white-box-top-left.gif', array('alt' => '')); ?>
                        </span>
                        <span class="right">
                            <?php echo $html->image('white-box-top-right.gif', array('alt' => '')); ?>
                        </span>
                        <div class="clear"></div>
                    </div>
                    <div class="content">
                        <div id="blueBox">
                            <div class="top">
                                <span class="left">
                                    <?php echo $html->image('blue-border-box-top-left.gif', array('alt' => '')); ?>
                                </span>
                                <span class="right">
                                    <?php echo $html->image('blue-border-box-top-right.gif', array('alt' => '')); ?>
                                </span>
                                <div class="clear"></div>
                            </div>
                                        ...
                                        <div class="homeContentRight news">
                                            ...
                                            foreach ($News as $news) {
                                                ...
                                                <div class="<?php echo $class; ?>">
                                                    <div class="date"><?php
                                            echo date("M", strtotime($news['Article']['modified']));
                                                ?><span><?php
                                                    echo date("d", strtotime($news['Article']['modified']));
                                                ?></span></div>
                                                    <div class="newsContent"><?php echo $news['Article']['title']; ?> <a href="<?php echo $html->url('/articles/index/' . $news['Article']['id']) ?>"><div class="read_more">Read More</div></a></div>
                                                    <div class="clear"></div>
                                                </div>
                            ...
                            <div class="bottom">
                                <span class="left">
                                    <?php echo $html->image('blue-border-box-bottom-left.gif', array('alt' => '')); ?>
                                </span>
                                <span class="right">
                                    <?php echo $html->image('blue-border-box-bottom-right.gif', array('alt' => '')); ?>
                                </span>
                                <div class="clear"></div>
                            </div>
                        </div>
                    ...
                    <div class="bottom">
                        <span class="left">
                            <?php echo $html->image('white-box-bottom-left.gif', array('alt' => '')); ?>
                        </span>
                        <span class="right">
                            <?php echo $html->image('white-box-bottom-right.gif', array('alt' => '')); ?>
                        </span>
                        <div class="clear"></div>
                    </div>
                    <div class="clear"></div>
