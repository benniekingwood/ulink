...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml">
    <head>
        ...
        <?php
        echo $html->meta('icon');
        echo $html->css(array('style_admin.css', 'pop_thickbox.css'));
    ...
    <body>
        ...
        <div id="mainContainer">
            <div id="header">
                <div class="left"><?php echo $html->image('logouLinkv2.png', array('alt' => 'uLink Logo')); ?></div>

                <?php echo $this->element('admin_login_tab'); ?>

                <div class="searchPanel">
                    <div class="left">
                        <a href="<?php e($html->url('/admin')); ?>">
                            <?php echo $html->image('home-icon.gif', array('alt' => '')); ?>
                        </a>
            ...
            <div id="whiteContentBox">
                <div class="top">
                    <span class="left"><?php echo $html->image('white-box-top-left.gif', array('alt' => '')); ?></span>
                    <span class="right"><?php echo $html->image('white-box-top-right.gif', array('alt' => '')); ?></span>
                    <div class="clear"></div>
                </div>
                <div class="content">
                    <div id="blueBox">
                ...
                <div class="bottom">
                    <span class="left"><?php echo $html->image('white-box-bottom-left.gif', array('alt' => '')); ?></span>
                    <span class="right"><?php echo $html->image('white-box-bottom-right.gif', array('alt' => '')); ?></span>
                    <div class="clear"></div>
                </div>
            </div>
            <!--<div class="share">
			<div class="left"><?php echo $html->image('find-us.gif', array('alt' => 'Find us on')); ?></div>
