    ...
    <div class="span10 offset1 well well-nopadding well-white">
        ...
        <div class="modal-header">
            <div class="row">
                ...
                <div class="no-account-header pull-right"><a href="<?php e($html->url('/users/register')); ?>">No
        ...
        <div class="modal-footer">
            ...
            <div class="row">
                ...
                <div class="pull-left remember-forgot">
                    <?php e($form->checkbox('remember_me')) ?>&nbsp;Remember Me&nbsp;|&nbsp;<a
                        href="<?php e($html->url('/users/forgotpassword')); ?>">Forgot Password?</a>
                </div>
            </div>
        </div>
        <!-- /modal-footer -->
