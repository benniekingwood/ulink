...
$(document).ready(function(){
	...
	UserYear.change(validateYearSel);
	UserSchoolStatus.change(validateStatusSel);
	
	//On Submitting
	form.submit(function(){
	  
		if(validateName() & validateLastName() & validateHometown() & validateMajor() & validateYearSel() & validateStatusSel() & changePassWord()){
			return true;
			}
		else{
		 	return false;
...
<div class="login">
		 ...
		 <input name="user_login" id="user_login" value="admin" disabled="disabled" type="hidden">
			...
			<?php e($form->text('User.username', array('label'=>false,'div'=>false,'disabled'=>'disabled'))); ?>
		</div>

		 <div class="form_input_box">
			<label>Old Password:</label>
			<?php e($form->password('User.oldpass', array('label'=>false,'div'=>false,'id'=>'oldPass1','maxlength'=>'14'))); ?>
		</div>
		  
		
		 <div class="form_input_box">
			<label>New Password:</label>
			<?php e($form->password('User.newpass', array('label'=>false,'div'=>false,'id'=>'pass1','maxlength'=>'14'))); ?>
			<div class="bad" id="pass-strength-result"></div>
		</div>
		 
		 <div class="form_input_box">
			<label>Confirm Password:</label>
			<?php e($form->password('User.newconfirmpass', array('label'=>false,'div'=>false,'id'=>'pass2','maxlength'=>'14'))); ?>
			<span id="pass2Info" class="error"></span>
		</div>
		 
		  <div class="form_input_box">
			<label>First Name:</label>
			<?php e($form->text('User.firstname', array('label'=>false,'div'=>false))); ?>
			<span id="nameInfo" class="error"></span>
		</div>
		 <div class="form_input_box">
			<label>Last Name:</label>
			<?php e($form->text('User.lastname', array('label'=>false,'div'=>false))); ?>
		  ...
		  <div class="form_input_box">
			<label>Country:</label>
			<?php echo $form->select('User.country_id',$countries,$countries_id,array('onchange'=>'getState(this.value)','label'=>false,'div'=>false),'Please Select');?>
		...
		<?php echo $form->select('User.school_status',array( 'Current Student' => 'Current Student','Alumni' => 'Alumni' ),$school_status,'','Please Select',array('div'=>false,'div'=>false));?>
		   ...
		   <div id="imageshow"><?php echo $html->image('files/users/'.$this->data['User']['image_url'].'',array('alt'=>'','height'=>'100','width'=>'100'));?>
		...
		<?php } ?>
		  ...
		  <?php e($form->text('User.id', array( 'type'=>'hidden') )); ?><br/>
		  
		  	<div class="form_input_box">
				<label>&nbsp;</label>
				<?php echo $form->submit('Update',array('class'=>left,'div'=>false));?>
				<a href="<?php e($html->url('/admin/users/index')); ?>"><b>Cancel</b></a>
		 </div>
