        ...
        <div class="span3">
            <div>
                <ul id="sidebar-nav" class="nav nav-tabs nav-stacked">
                    ...
                    <li><a href="<?php e($html->url('/users/password'));?>"><i class="icon-lock"></i>Password</a></li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="span2">
                        <?php if ($this->data['User']['image_url'] != '' && file_exists(WWW_ROOT . '/img/files/users/' . $this->data['User']['image_url'])) {?>
                            <div id="profile-image">
                                <?php echo $html->image('files/users/' . $this->data['User']['image_url'] . '', array('alt' => 'profile image')); ?>
                                <br />
                                <?php echo $html->link('Remove this image', array('action' => 'removeImage', $this->data['User']['image_url']), array('class' => 'remove-profile-image', 'id' => $this->data['User']['id'], 'image_url' => $this->data['User']['image_url'])); ?>
                            </div>
                        <?php } else { ?>
                            <div>
                                <?php echo $html->image('files/users/noImage.jpg', array('alt' => 'noprofileimagg')); ?>
                            </div>
                        <?php } ?>
                    </div>
                    <div class="span3">
