    ...
    <table border="1" cellpadding="0" cellspacing="0" id="myTable" class="listing edit" >
        ...
        <tr> 
            ...
            <tr id="<?php echo $user['User']['id'] ?>">    
                ...
                <td><a class="changeStatus" path="<?php e($html->url('/admin/users/user_changeStatus/' . $user['User']['id'])); ?>" id="<?php echo $user['User']['id']; ?>"><?php if ($user['User']['activation'] == 0)
                    echo "<img src='" . $html->url('/img/unpublish.png') . "' border='0'>"; else
                    echo "<img src='" . $html->url('/img/publish.png') . "' border='0'>"; ?></a></td>

                <td><a href="<?php e($html->url('/admin/users/user_edit/' . $user['User']['id'])); ?>"><img src="<?php e($html->url('/img/edit-icon.png')); ?>" border="0"/></a></td>
                <td><?php echo $html->link('<img src="' . $html->url('/img/delete.gif') . '" />', array('action' => 'user_delete', $user['User']['id']), array('class' => 'confirm_delete', 'id' => $user['User']['id'], 'escape' => false)); ?></td>                 
            </tr>
<?php } ?>
    </table>
...
<?php echo $this->element('paging'); ?>
    ...
    <div class="admin_link">
        ...
        <a href="<?php e($html->url('/admin/users/user_add/')); ?>">Add User</a>
    </div>
</div>