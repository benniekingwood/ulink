    ...
    <table border="1" cellpadding="0" cellspacing="0" width="99%" id="myTable">
        ...
        foreach ($Suggestion as $suggestion) {
            ...
            <tr style='background-color:yellow;' id="<?php echo $suggestion['Suggestion']['id'] ?>">    
                ...
                <td><?php echo $html->link('Delete', array('action' => 'suggestion_delete', $suggestion['Suggestion']['id']), array('class' => 'confirm_delete', 'id' => $suggestion['Suggestion']['id'])); ?></td>        
            </tr>
<?php } ?>
    </table>
    ...
    <div><a href="<?php e($html->url('/admin/admins/index/')); ?>">Back</a><br/>
    </div>
</div>