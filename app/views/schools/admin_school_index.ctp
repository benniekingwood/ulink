...
<div id="SchoolList">
     <table border="1" cellpadding="0" cellspacing="0" id="myTable"  class="listing edit">
        <tr class="ListHeading">
		 ...
		 <td><a href="<?php e($html->url('/admin/schools/school_edit/'.$School['School']['id'])); ?>"><img src="<?php e($html->url('/img/edit-icon.png')); ?>" border="0"/></a></td>
		 <td><?php echo $html->link('<img src="'.$html->url('/img/delete.gif').'" />',array('action'=>'School_delete',$School['School']['id']),array('class'=>'confirm_delete','id'=>$School['School']['id'],'escape'=>false));?>              
              </tr>
		<?php }}  else { ?>
...
<div>
<a href="<?php e($html->url('/admin/schools/school_add/')); ?>">Add School</a>
</div>
</div>