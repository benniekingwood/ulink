            ...
            <div class="sliderContent">
                <span class="sliderImage">
                    <a href="schools/detail/<?php echo $topRatedSchool['School']['id']; ?>">
                        <img alt="" border="0" src="<?php e($html->url('/thumbs/index/')); ?>?src=/app/webroot/img/files/schools/<?php echo $topRatedSchool['School']['image_url']; ?>&w=50&h=50" /></a>
                </span>
                <span>
                    ...
                    <?php 
                        if ($topRatedSchool['School']['rating'] > 0) {
                            echo $html->image('star-' . $topRatedSchool['School']['rating'] . '.gif', array('title' => $topRatedSchool['School']['rating'] . ' star')); 
                        }
                    ?> 
                </span>
