...
echo $html->css(array('jquery_thumbs.css'));
?>
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //searchbox init
        $('#searchterms2').autocomplete( birdnames, { minChars:2, width:250, matchContains:true, matchSubset:true, max:50, cacheLength:20
        });
...
<div class="contentInner">
                ...
                <div class="jcarousel-clip jcarousel-clip-horizontal">
                    <ul id="features" class="jcarousel-list jcarousel-list-horizontal">
                        ...
                        for ($j = 0; $j < count($VideoReviewCaps); $j++) { ?>
                            ...
                            ?>
                            <a class="videoListingThumbs" href="<?php e($html->url('/reviews/videoreview/' . $OtherVideoReview[$j]['Review']['id'] . '')); ?>"><?php echo $VideoReviewCaps[$j]['image_thumb'][0]; ?><br /><strong><?php echo substr($OtherVideoReview[$j]['Review']['title'], 0, 15); ?></strong><br /><?php echo substr($OtherVideoReview[$j]['Review']['description'], 0, 12); ?></a>
                            <?php
    ...
    <div id="leftContent">
        <div class="user-rating">
            ...
            <div class="userName">
                ...
                <?php
                if ($VideoReview[0]['User']['image_url'] == "" || !is_file($html->url('/app/webroot/img/files/users/' . $VideoReview[0]['User']['image_url']))) {
                    $VideoReview[0]['User']['image_url'] = "noImage.jpg";
                }
                ?>  
                <img alt="profile picture" border="0" src="<?php e($html->url('/thumbs/index/')); ?>?src=/app/webroot/img/files/users/<?php echo $VideoReview[0]['User']['image_url']; ?>&w=50&h=50" />

                <a href="<?php e($html->url('/users/userinfo/' . $VideoReview[0]['User']['id'] . '')); ?>"><?php echo ucwords($VideoReview[0]['User']['firstname']); ?></a></div>
            <div class="rating">
                <span class="right"><?php
                if ($VideoReview[0]['Review']['rating'] == 0) {
                    echo ": No rating yet";
                } else {
                    echo $html->image('star-' . $VideoReview[0]['Review']['rating'] . '.gif', array('title' => $VideoReview[0]['Review']['rating'] . ' star'));
                }
                ?></span>
        ...
        <div class="boxBottom">
            <div class="date"><?php echo date("d M, Y ", strtotime($VideoReview[0]['Review']['created'])); ?></div>
            <div class="links">
                <a href="<?php e($html->url('/reviews/alltextreview/' . $VideoReview[0]['School']['id'] . '')); ?>">Written Reviews</a>  |  <a href="<?php e($html->url('/schools/detail/' . $VideoReview[0]['School']['id'] . '')); ?>">School Information</a>
            </div>
            <div class="clear"></div>
        </div>
        <br />
    ...
    <div id="rightContent">
        <div class="recent">
                        ...
                        <li class="<?php echo $class; ?>">
                            ...
                            <span class="right"><?php
                                if ($otherWrittenReview['Review']['rating'] == 0) {
                                    ...
                                    echo $html->image('review_star_' . $otherWrittenReview['Review']['rating'] . '.png', array('title' => $otherWrittenReview['Review']['rating'] . ' star'));
                                }
                                    ?></span>
                            <span class="content">
                                <?php echo substr($otherWrittenReview['Review']['description'], 0, 40); ?>...
                            </span>
                            <span class="right"><a href="<?php e($html->url('/reviews/textreview/' . $otherWrittenReview['Review']['id'] . '')); ?>" class="home_read"><div class="read_more left">Read More</div></a> &nbsp;</a></span>
                        </li>                                                                                                                  
                        <?php $i++;
                    } ?>
                    <li class="clear"></li>
            ...
            <a href="<?php e($html->url('/reviews/alltextreview/' . $otherWrittenReview['School']['id'] . '')); ?>" class="viewAll">View All Reviews </a>
            <div class="clear"></div>
        </div>
    </div>
    <div class="clear"></div>
