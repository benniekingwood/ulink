<script type="text/javascript" language="javascript">
    reviewVideoPopup = function(id,i){
        $('#video'+i).click(function() {
            tb_show("Video Review","<?php echo e($html->url('/admin/reviews/video?mode=1&height=310&width=250&code=')) ?>"+id, null);
        });
    }
</script>
...
<div id="ReviewList">
    <table border="1" cellpadding="0" cellspacing="0" id="myTable"  class="listing edit">
        <tr class="ListHeading">
            ...
            ?></a></td>
                <td><a href="<?php e($html->url('/admin/reviews/review_edit/' . $Review['Review']['id'])); ?>"><img src="<?php e($html->url('/img/edit-icon.png')); ?>" border="0"/></a></td>
                <td><?php echo $html->link('<img src="' . $html->url('/img/delete.gif') . '" />', array('action' => 'review_delete', $Review['Review']['id']), array('class' => 'confirm_delete', 'id' => $Review['Review']['id'], 'escape' => false)); ?></td>                 
                </tr>
    <?php }
} else { ?>
