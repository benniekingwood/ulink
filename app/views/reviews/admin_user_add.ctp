...
$(document).ready(function(){
	...
	//On Change
	UserSchoolId.change(validateSchoolSel);
	...
	form.submit(function(){
		...
		if(validateName() & validateLastName() & validateEmail() & validatePass1() & validatePass2() & validateUserName() & validateHometown() & validateMajor() & validateSchoolSel() & validateYearSel() & validateStatusSel() & validatedomainCheck())
			return true;
		else
			return false;
	});
...
<?php echo $form->create('User', array('action' => 'admin_user_add','name'=>'UserAdminUserAddForm','type'=>'file'));?>
		...
		<?php echo $form->input('firstname');?> 
		 ...
		 <br/><br/>
		 Country <?php echo $form->select('country_id',$countries,'',array('onchange'=>'getState(this.value)'),'Please Select');?>							<br/>
	  ...
	  <option>Select State First</option>
		 ...
		 <?php echo $form->select('school_status',array( 'Current Student' => 'Current Student','Alumni' => 'Alumni' ),'','','Please Select');?>
		  ...
		  <?php echo $form->submit('Submit');?> <div><a href="<?php e($html->url('/admin/users/index')); ?>"><b>Cancel</b></a></div>
