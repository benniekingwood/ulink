        ...
        if (!empty($Suggestion)) {
            ...
            foreach ($Suggestion as $Suggestion) {
                ...
                <tr id="<?php echo $Suggestion['Suggestion']['id'] ?>">    
                    ...
                    <td><?php echo $html->link('<img src="' . $html->url('/img/delete.gif') . '" />', array('action' => 'suggestion_delete', $Suggestion['Suggestion']['id']), array('class' => 'confirm_delete', 'id' => $Suggestion['Suggestion']['id'], 'escape' => false)); ?>              
                </tr>
    <?php }
} else { ?>
