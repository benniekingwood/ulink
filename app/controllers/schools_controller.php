...
class SchoolsController extends AppController {
    ...
    var $helpers = array('Fck', 'Html', 'Form', 'Javascript', 'Ajax', 'Jquery');
    ...
    function admin_school_index() {
        ...
        if (isset($this->data['School']['searchText'])) {
            $this->Session->write('advancedSchoolSearch', $this->data['School']['searchText']);
...
//ef 	
    ...
    function admin_school_add() {
        ...
        if (!empty($this->data)) {
            ...
            $fileOK = $this->uploadFiles('img/files/schools', $this->data['School']['file']);

            if (array_key_exists('urls', $fileOK)) {
                $this->data['School']['image_url'] = $fileOK['urls'][0];
            }
